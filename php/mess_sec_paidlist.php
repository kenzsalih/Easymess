...
// Fetch payment records for selected month and year
$sql = "SELECT * FROM mess_payments WHERE month = ? AND year = ? ORDER BY submission_date DESC";
...
<body>
    ...
    <div class="month-selector">
        <form method="POST">
            ...
            <input type="submit" value="Show Paid List">
        </form>
    </div>
    ...
    <div class="payment-container">
        <div class="summary">
            <h3>Summary</h3>
            <p>Total Paid Records: <?php echo $result->num_rows; ?></p>
                ...
                <tbody>
                    <?php while($payment = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo date('d-m-Y H:i', strtotime($payment['submission_date'])); ?></td>
                            <td>
        ...
        <?php else: ?>
            <p>No payment records found for <?php echo $months[$selectedMonth] . ' ' . $selectedYear; ?>!</p>
        <?php endif; ?>
    </div>

    <a href="mess_sec_paymentstatus.php" class="back-button">Back to Payment Options</a>
    <button class="export-button" onclick="window.print()">Print Page</button>
</body>
</html>
